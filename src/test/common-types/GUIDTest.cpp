...
void GUIDTest::test_parse()
{
  ...
  std::string temp_s;
  std::array<unsigned char, 16> temp_a;


  temp_s = "{00000000-0000-0000-0000-000000000000}";
  temp_a = {{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
  cases.emplace_back(temp_s,temp_a);
  temp_s = "{ffffffff-ffff-ffff-ffff-ffffffffffff}";
  temp_a = {{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}};
  cases.emplace_back(temp_s,temp_a);
  temp_s = "{7b5c52e4-d88c-4da7-aeb1-5378d02996d3}";
  temp_a = {{0xe4, 0x52, 0x5c, 0x7b, 0x8c, 0xd8, 0xa7, 0x4d, 0xae, 0xb1, 0x53, 0x78, 0xd0, 0x29, 0x96, 0xd3}};
  cases.emplace_back(temp_s,temp_a);
